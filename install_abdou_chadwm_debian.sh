...
apt update
apt install -y build-essential dash x11-utils acpi libxft-dev libimlib2-dev libxinerama-dev pamixer brightnessctl conky-all nitrogen pcmanfm geany rsync sxhkd picom rofi alacritty fontconfig || {
